namespace Jambox.Tourney.UI
{
    ...
    public class FriendlyListView : MonoBehaviour
    {
        ...
        public delegate void ItemDelegate(FriendlylistViewItem item, int rowIndex);
        ...
        protected FriendlyTourneyItem[] childItems;
        ...
        public virtual void Refresh(FriendlylistViewItem item)
        {
        ...
        public FriendlyTourneyItem GetRowItem(int row)
        {
            if (childItems != null &&
        ...
        protected virtual bool CheckChildItems()
        {
            ...
            if (rebuild)
            {
                ...
                if (childItems == null)
                    childItems = new FriendlyTourneyItem[childCount];
