namespace Jambox.Tourney.UI
{
    ...
    /// <summary>
    /// TourneyListView uses a Unity UI ScrollRect to provide an efficiently scrolling list.
    ...
    public class TourneyListView : MonoBehaviour
    {
        ...
        public void UpdateItem(bool isTourneyPrefab = true, bool isDuelPrefab = false)
        {
            DestroyAll();
            if (isTourneyPrefab)
        ...
        public delegate void ItemDelegate(TourneyListViewItem item, int rowIndex);
        ...
        protected TourneyListViewItem[] childItems;
        ...
        public virtual void Refresh(TourneyListViewItem item)
        {
            for (int i = 0; i < childItems.Length; ++i)
            {
        ...
        public TourneyListViewItem GetRowItem(int row)
        {
            if (childItems != null &&
        ...
        protected virtual bool CheckChildItems()
        {
            ...
            if (rebuild)
            {
                ...
                if (childItems == null)
                    childItems = new TourneyListViewItem[childCount];
        ...
        {
            float yHit = loadedItem.RectTransform.rect.height;
        ...
        protected virtual void UpdateChild(TourneyListViewItem child, int rowIdx)
        {
