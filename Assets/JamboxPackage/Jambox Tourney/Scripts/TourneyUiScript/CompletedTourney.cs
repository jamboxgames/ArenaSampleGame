namespace Jambox.Tourney.UI
{
    ...
    public class CompletedTourney : MonoBehaviour
    {
        ...
        public void OnEnable()
        {
            ...
            _ = CommunicationController.Instance.GetCompletedTourneyData(authToken, "1", (data) => { CompletedTDataRcvd(data); }, (errorMsg) => { UIPanelController.Instance.ErrorFromServerRcvd(errorMsg); });
        }
